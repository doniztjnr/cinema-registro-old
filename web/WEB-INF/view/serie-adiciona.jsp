            ...
            <div class="d-lg-flex">
                <div class="mb-3 flex-lg-grow-1 me-lg-3">
                    ...
                    <input type="text" class="form-control border border-primary-subtle" id="inputNone"
                           placeholder="Escreva aqui o nome da série">
                </div>
                <div class="mb-3 mx-lg-2">
                    <label for="inputDataDeLançamento" class="form-label">Data de lançamento</label>
                    <input type="date" class="form-control border border-primary-subtle" id="inputDataDeLançamento">
                </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="mb-3 ms-4 ms-lg-3">
                        <label for="inputTotalDeEpisodios" class="form-label">Total de episódios</label>
